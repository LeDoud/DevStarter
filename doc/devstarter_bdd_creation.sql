...
/* Date de création :  02/05/2013 20:39:14                      */
/*==============================================================*/
...
ALTER TABLE FILE ADD CONSTRAINT FK_JOIN_PROJECT_FILE FOREIGN KEY (PROJECT_ID)
      REFERENCES PROJECT (ID_PROJECT) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE USER ADD CONSTRAINT FK_EXERCE FOREIGN KEY (COMPTE_ENUM_ID)
      REFERENCES ENUMERATION (ID_ENUMERATION) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE USER ADD CONSTRAINT FK_S_AUTHENTIFIE FOREIGN KEY (JOB_ENUM_ID)
      REFERENCES ENUMERATION (ID_ENUMERATION) ON DELETE RESTRICT ON UPDATE RESTRICT;
